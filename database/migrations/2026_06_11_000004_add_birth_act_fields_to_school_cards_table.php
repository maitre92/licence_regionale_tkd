...
return new class extends Migration
{
    ...
    {
        Schema::table('school_cards', function (Blueprint $table) {
            if (!Schema::hasColumn('school_cards', 'birth_act_number')) {
                $table->string('birth_act_number')->nullable()->after('birth_place');
    ...
    public function down(): void
    {
        Schema::table('school_cards', function (Blueprint $table) {
            foreach ([
                ...
                if (Schema::hasColumn('school_cards', $column)) {
